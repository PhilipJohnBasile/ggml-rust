...
transpose, broadcasting, RMSNorm, SiLU, stable softmax, and grouped-query
scaled dot-product attention. The same operation boundary is intended to be
lowered to Apple GPU kernels as the native device backend is added.
